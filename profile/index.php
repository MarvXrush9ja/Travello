						...
						<div class="home_search_content">
							<form action="#" method="post" class="home_search_form" id="home_search_form">
								<div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start">
									<input type="text" name="search_city" class="search_input search_input_1" placeholder="City" required="required">
									<input type="text" name="search_depart" class="search_input search_input_2" placeholder="Departure" required="required">
									<input type="text" name="search_arrival" class="search_input search_input_3" placeholder="Arrival" required="required">
									<input type="text" name="search_budget" class="search_input search_input_4" placeholder="Budget" required="required">
									<button type="submit" name="submit" class="home_search_button">search</button>
								</div>
							</form>
						</div>
					</div>
					...
					<div class="destinations_container item_grid">
						...
						<div class="destination item">
							...
							<div class="destination_content">
								<div class="destination_title"><a href="destinations.html"><?php echo $post_name; ?></a></div>
								<div class="destination_subtitle"><p><?php echo $post_content ?></p></div>
								<div class="destination_price">From $<?php echo $post_price; ?></div>
							</div>
						</div>
