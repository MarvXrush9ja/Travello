						...
						<div class="home_search_content">
							<form action="#" method="post" class="home_search_form" id="home_search_form">
								<div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start">
									...
									<input type="text" name="search_depart" class="search_input search_input_2" placeholder="Departure" >
									<input type="text" name="search_arrival" class="search_input search_input_3" placeholder="Arrival" >
									<input type="text" name="search_budget" class="search_input search_input_4" placeholder="Budget" >
